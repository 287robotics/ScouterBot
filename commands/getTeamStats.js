...
function execute(interaction) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            blueAlliance.requestTeamData(teamNumber, function (teamData) { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    blueAlliance.requestEventData(teamNumber, function (eventData) { return __awaiter(_this, void 0, void 0, function () {
                        var embed, eventName, fieldData, dataString, event_1, matches;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
